...
public class GroupeManager {
    ...
    public static final String KEY_FILIERE_GROUPE="Filiere";
    ...
    public long addGroupe(Groupe groupe) {
        ...
        values.put(KEY_FILIERE_GROUPE, groupe.getFiliere());
    ...
    public Groupe getGroupe(int id) {
        ...
        if (c.moveToFirst()) {
            ...
            a.setFiliere(c.getString(c.getColumnIndex(KEY_FILIERE_GROUPE)));

...
public class AccessServiceAPI {
     ...
     * @return json string
     */
    public String getJSONStringWithParam_POST2(String serviceUrl, Map<String, ArrayList<HashMap<String,Object>>> params)
            throws IOException
    {
        JSONArray jsonArray = null;
        String jsonString = null;
        ...
        StringBuilder bodyBuilder = new StringBuilder();
        Iterator<Map.Entry<String, ArrayList<HashMap<String, Object>>>> iterator = params.entrySet().iterator();
        // constructs the POST body using the parameters
        while (iterator.hasNext())
        {
            Map.Entry<String, ArrayList<HashMap<String, Object>>> param = iterator.next();
            bodyBuilder.append(param.getKey()).append('=')
                    .append(param.getValue());
            if (iterator.hasNext()) {
                bodyBuilder.append('&');
